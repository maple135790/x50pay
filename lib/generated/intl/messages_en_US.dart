...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addFavGameTitle": MessageLookupByLibrary.simpleMessage(
      "Add Favorite Game",
    ),
    "changeFavGameSubtitle": MessageLookupByLibrary.simpleMessage(
      "Change the machines you play most often",
    ),
    "changeFavGameTitle": MessageLookupByLibrary.simpleMessage(
      "Change Favorite Game",
    ),
    "confirmExitAppContent": MessageLookupByLibrary.simpleMessage(
      "Do you want to exit X50Pay?",
    ),
    "confirmExitAppTitle": MessageLookupByLibrary.simpleMessage(
      "Closing X50Pay",
    ),
    "continuous": m0,
    ...
    "dressRoomTitle": MessageLookupByLibrary.simpleMessage(
      "Change avater/clothes",
    ),
    "gacha": m1,
    ...
    "loginBiometrics": MessageLookupByLibrary.simpleMessage("Biometric Login"),
    ...
    "loginSignUp": MessageLookupByLibrary.simpleMessage("Not have account ?"),
    ...
    "setFavGameTitle": MessageLookupByLibrary.simpleMessage(
      "Setup favorite game",
    ),
    "summaryGame": MessageLookupByLibrary.simpleMessage("Game"),
    "summaryGameDetailed": MessageLookupByLibrary.simpleMessage("Game"),
    "summaryGameFavGame": MessageLookupByLibrary.simpleMessage("Favorite Game"),
    "summaryGameFavGameSetup": MessageLookupByLibrary.simpleMessage(
      "Not Set Favorite Game Yet",
    ),
    ...
    "summaryGameRecordTitle": MessageLookupByLibrary.simpleMessage(
      "Game Record:",
    ),
    "summaryHide": MessageLookupByLibrary.simpleMessage("Hide"),
    "summaryNoData": MessageLookupByLibrary.simpleMessage("No Data"),
    "summaryPeriod": MessageLookupByLibrary.simpleMessage("Calculation Period"),
    ...
    "ticketBalance": MessageLookupByLibrary.simpleMessage("Ticket Balance : "),
    "ticketUnit": MessageLookupByLibrary.simpleMessage(" "),
    "userAppSettingsAccentColor": MessageLookupByLibrary.simpleMessage(
      "Accent Color",
    ),
    "userAppSettingsBiometrics": MessageLookupByLibrary.simpleMessage(
      "Biometrics login",
    ),
    "userAppSettingsBiometricsDisable": MessageLookupByLibrary.simpleMessage(
      "Disable Biometrics login",
    ),
    "userAppSettingsBiometricsDisableContent": MessageLookupByLibrary.simpleMessage(
      "You are going to disable Biomertrics Login.\nYou will be prompt to enter your login credentials in order to re-enable it.",
    ),
    "userAppSettingsBiometricsEnableContent": MessageLookupByLibrary.simpleMessage(
    ...
    "userAppSettingsBiometricsLoginCred": MessageLookupByLibrary.simpleMessage(
      "Login Credentials",
    ),
    ...
    "userAppSettingsBiometricsLoginTry": MessageLookupByLibrary.simpleMessage(
      "Try to log in",
    ),
    "userAppSettingsCardEmulationInterval":
        MessageLookupByLibrary.simpleMessage("Card Emulation Interval"),
    "userAppSettingsEnableDarkTheme": MessageLookupByLibrary.simpleMessage(
      "Dark Theme",
    ),
    "userAppSettingsFastPayment": MessageLookupByLibrary.simpleMessage(
      "Fast payment",
    ),
    "userAppSettingsFastPaymentEnableContent": MessageLookupByLibrary.simpleMessage(
    ...
    "userAppSettingsInAppNfc": MessageLookupByLibrary.simpleMessage(
      "In-App NFC tag read",
    ),
    ...
    "userAppSettingsRememberGameTabTitle": MessageLookupByLibrary.simpleMessage(
      "Remember the last tab in Game page",
    ),
    "userAppSettingsResetTheme": MessageLookupByLibrary.simpleMessage(
      "Reset Theme",
    ),
    ...
    "userFPlayLog": MessageLookupByLibrary.simpleMessage("Cashback history"),
    "userInAppSetting": MessageLookupByLibrary.simpleMessage(
      "X50Pay App Settings",
    ),
    "userLogout": MessageLookupByLibrary.simpleMessage("Logout X50Pay"),
    "userNFC": MessageLookupByLibrary.simpleMessage("Multi Payment Setting"),
    "userOpenDoor1": MessageLookupByLibrary.simpleMessage(
      "Open \"Ximen 1 Store\" door",
    ),
    "userOpenDoor2": MessageLookupByLibrary.simpleMessage(
      "Open \"Ximen 2 Store\" door",
    ),
    "userPad": MessageLookupByLibrary.simpleMessage("Online queue Setting"),
    "userPassword": MessageLookupByLibrary.simpleMessage(
      "Change user password",
    ),
    "userPhone": MessageLookupByLibrary.simpleMessage("Change user cellphone"),
    "userPlayLog": MessageLookupByLibrary.simpleMessage("Used point history"),
    "userQUIC": MessageLookupByLibrary.simpleMessage("X50QuIC Payment Setting"),
    "userTicLog": MessageLookupByLibrary.simpleMessage("Unused ticket history"),
    "userUTicLog": MessageLookupByLibrary.simpleMessage("Usage ticket history"),
