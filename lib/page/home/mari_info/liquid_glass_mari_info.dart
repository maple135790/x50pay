...
class LiquidGlassMariInfo extends StatefulWidget {
  const LiquidGlassMariInfo({super.key});

  @override
  State<LiquidGlassMariInfo> createState() => _LiquidGlassMariInfoState();
}

class _LiquidGlassMariInfoState extends State<LiquidGlassMariInfo>
    with AppThemeMixin {
